...
file `ljE8aFvLz8Q0Wtd5TmdyhQ` (Ledger, cobalt accent). `/assets/tempo-20260908.css`
...
`src/bin/tempo_fixture.rs` serves the console from the in-memory store with no
