//! Synthetic Delta console for local UI review — in-memory store, no database, no egress.
...
const LISTEN_ADDR: &str = "127.0.0.1:9138";
...
async fn main() {
    ...
    tracing::info!(%addr, "Delta synthetic fixture listening");
